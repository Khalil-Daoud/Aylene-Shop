...
const Footer = () => {
  ...
  //         {/* Company Info */}
  //         <div>
  //           <h3 className="text-xl font-bold mb-4">Aylen Gadgets el Hamma</h3>
  ...
  //               <a href="mailto:info@Aylen Gadgets.com" className="text-muted-foreground hover:text-red-600 transition-colors duration-200">
  //                 info@Aylen Gadgets.com
  //               </a>
  //             </li>
  //           </ul>
  //         </div>
  ...
  //             &copy; {new Date().getFullYear()} Aylen Gadgets el Hamma. All rights reserved.
  //           </p>
  //           <div className="flex space-x-4">
    ...
    <footer className="bg-secondary pt-16 pb-6">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Infos Entreprise */}
          <div>
            <h3 className="text-xl font-bold mb-4">Aylen Gadgets</h3>
            <p className="text-muted-foreground mb-4">
              Expérience de shopping premium pour les passionnés de technologie
              et les amateurs de lifestyle.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-foreground/60 hover:text-red-600 transition-colors duration-200"
                aria-label="Facebook"
              >
                <Facebook size={20} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin
                  size={18}
                  className="mr-2 text-red-600 flex-shrink-0 mt-1"
                />
                <span className="text-muted-foreground">Aylen Gadgets</span>
              </li>
              <li className="flex items-center">
                <Phone size={18} className="mr-2 text-red-600 flex-shrink-0" />
                <a
                  href="whatsapp:+21699616359"
                  className="text-muted-foreground hover:text-red-600 transition-colors duration-200"
                >
                  +216 99616359
                </a>
              ...
              <li className="flex items-center">
                <Mail size={18} className="mr-2 text-red-600 flex-shrink-0" />
                <a
                  href="mailto:AylenGadgets@gmail.com"
                  className="text-muted-foreground hover:text-red-600 transition-colors duration-200"
                >
                  AylenGadgets@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Aylen Gadgets. Tous droits
              réservés.
            </p>
            <div className="flex space-x-4">
              <Link
