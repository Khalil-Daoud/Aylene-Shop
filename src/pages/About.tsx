...
import AymenImage from '../img/Aymen.png';
import WaelImage from '../img/Wael.png';
import OnsImage from '../img/Ons.png';
...
const About = () => {
  ...
  return (
    ...
    <div className='mt-[70px]'>
      <Helmet>
        <title>À propos | Aylen Gadgets</title>
      </Helmet>
      ...
      <div className="pt-28 pb-16">
        ...
        <div className="container mx-auto px-6 mb-16">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">À propos de Aylen Gadgets</h1>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Chez Aylen Gadgets, notre mission est de rendre la technologie haut de gamme accessible à tous. L'innovation doit améliorer la vie quotidienne, et nous sélectionnons des produits qui y contribuent.
              </p>
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Notre vision</h2>
              <p className="text-muted-foreground">
                Nous imaginons un monde où la technologie s’intègre parfaitement à la vie de tous les jours. Aylen Gadgets s'engage à être un acteur clé de cette révolution, en offrant bien plus que des produits : des solutions.
              </p>
            </div>
        ...
        <div className="bg-secondary py-16">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-center mb-12">Pourquoi choisir Aylen Gadgets ?</h2>
        ...
        <div className="bg-secondary py-16">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              {[
                { year: "2015", title: "Fondation à El Hamma", description: "Aylen Gadgets est né avec une vision de transformation du commerce technologique." },
